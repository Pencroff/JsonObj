...
func TestFloatOps(t *testing.T) {
	...
	assert.Equal(t, 3.141592653589793, js.GetFloat())
	assert.Equal(t, true, js.IsNumber())
...
func TestBoolOps(t *testing.T) {
	js := JsonStruct{}
	js.SetBool(true)
	assert.Equal(t, true, js.GetBool())
	assert.Equal(t, true, js.IsBool())
	assert.Equal(t, "true", js.ToJson())
	js.SetBool(false)
	assert.Equal(t, false, js.GetBool())
...
func TestStringOps(t *testing.T) {
	js := JsonStruct{}
	js.SetString("hello")
	assert.Equal(t, "hello", js.GetString())
